...
enum RoomErrorCode {
  ...
  roomLimitReached(
    ...
    upsell: "You've hit your room limit. Delete an old room or get a Patron seat.",
  ),
  ...
  extendNotAllowed(
    ...
    upsell: "Rooms can't be extended on this plan. A Patron seat picks its own length.",
  ),
